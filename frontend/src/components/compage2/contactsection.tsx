  ...
  return (
    <section className="container mx-auto px-24 py-40">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Contact Form */}
        <form className="grid grid-cols-2 gap-4 text-gray-700">
          <div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="col-span-2 w-auto ml-auto bg-blue-600 text-white font-medium py-2 px-6 rounded-md mt-4 hover:bg-white hover:text-blue-600 hover:border hover:border-blue-600 transition-all"
          >
            Send
          </motion.button>
        </form>
